...
require 'deliverable_controller'

# Re-raise errors caught by the controller.
class DeliverableController; def rescue_action(e) raise e end; end

class DeliverableControllerTest < Test::Unit::TestCase
  fixtures :deliverables

  def setup
    @controller = DeliverableController.new
